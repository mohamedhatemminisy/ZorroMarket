    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title"> {{trans('admin.permissions')}} </h3>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        ...
                                                        <a href="{{route('permissions.edit',$permission -> id)}}" class="btn btn-sm btn-clean btn-icon mr-2 " title="@lang('admin.edit')">
                                                        ...
                                                        <form id="delete-form-{{ $permission->id }}" style="display: inline-table;" action="{{route('permissions.destroy',$permission -> id)}}" method="post">
                                                            @csrf
                                                            @method('delete')
                                                            <button type="button" class="btn btn-sm btn-clean btn-icon" title="@lang('admin.delete')" onclick="confirmDelete('delete-form-{{ $permission->id }}')">
