                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form"> {{trans('admin.edit')}} {{$test->name}} </h4>
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane fade show @if($key == 0) active @endif" id="{{$locale}}" role="tabpanel">
                                                    <div class="col form-group">
                                                        ...
                                                        <input type="text" name="{{ $locale.'[name]' }}" id="{{ $locale . '[name]' }}" placeholder="@lang('admin.name')" class="form-control @error(" $locale.name" ) is-invalid @enderror" value="{{old($locale.'.name',$test->translate($locale)->name )}}">
                                                        @error("$locale.name" )
                                                    ...
                                                    <div class="col form-group">
                                                        ...
                                                        <textarea class="form-control @error($locale . '.description') is-invalid @enderror " type="text" name="{{ $locale . '[description]' }}" rows="4" id="{{ $locale }}.editor1">{{old($locale.'.description',$test->translate($locale)->description )}}</textarea>
                                                    </div>
                                                    ...
                                                    <div class="col form-group">
                                                        <label>@lang('admin.type')(@lang('admin.'.$locale))<span class="text-danger">*</span></label>
                                                        <textarea class="form-control @error($locale . '.type') is-invalid @enderror " type="text" name="{{ $locale . '[type]' }}" rows="4" id="{{ $locale }}.editor2">{{old($locale.'.type',$test->translate($locale)->type )}}</textarea>
                                                    </div>
                                                    @error("$locale.type" )
                                                    <span class="text-danger">{{$message}}</span>
                                                    @enderror
