                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> {{trans('admin.edit')}} - {{$product -> name}}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form"> {{trans('admin.edit')}} - {{$product -> name}} </h4>
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane fade show @if($key == 0) active @endif" id="{{$locale}}" role="tabpanel">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="{{ $locale.'[name]' }}" id="{{ $locale . '[name]' }}" value="{{old($locale.'.name',$product->translate($locale)->name )}}" placeholder="@lang('admin.name')" class="form-control @error(" $locale.name" ) is-invalid @enderror" value="{{ old($locale.'.name') }}">
                                                        @error("$locale.name" )
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="col form-group">
                                                                ...
                                                                <textarea class="form-control @error($locale . '.description') is-invalid @enderror " type="text" name="{{ $locale . '[description]' }}" rows="4" id="{{ $locale }}.editor1">{{old($locale.'.description',$product->translate($locale)->description )}}</textarea>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="col form-group">
                                                                ...
                                                                <textarea class="form-control @error($locale . '.summary') is-invalid @enderror " type="text" name="{{ $locale . '[summary]' }}" rows="4" id="{{ $locale }}.editor2">{{old($locale.'.summary',$product->translate($locale)->summary )}}</textarea>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="added_by" class="select2 form-control">
                                                                ...
                                                                <option value="{{$vendor -> id }}" @if($product->added_by == $vendor->id) selected @endif>{{$vendor -> name}}</option>
                                                                @endforeach
                                                                @endif
                                                            </select>
                                                            @error('vendors')
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="slug" class="form-control" placeholder="{{trans('admin.slug')}}" value="{{old('slug', $product->slug)}}" name="slug">
                                                            @error("slug")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="quantity" class="form-control" placeholder="{{trans('admin.quantity')}}" value="{{old('quantity', $product->quantity)}}" name="quantity">
                                                            @error("quantity")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="sku" class="form-control" placeholder="{{trans('admin.sku')}}" value="{{old('sku', $product->sku)}}" name="sku">
                                                            @error("sku")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="price" class="form-control" placeholder=" {{trans('admin.price')}}" value="{{old('price', $product->price)}}" name="price">
                                                            @error("price")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="special_price" class="form-control" placeholder=" {{trans('admin.special_price')}}" value="{{old('special_price', $product->special_price)}}" name="special_price">
                                                            @error("special_price")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="start_date" class="form-control" placeholder=" {{trans('admin.start_date')}}" value="{{old('start_date', $product->start_date)}}" name="start_date">
                                                            @error("start_date")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="end_date" class="form-control" placeholder=" {{trans('admin.end_date')}}" value="{{old('end_date', $product->end_date)}}" name="end_date">
                                                            @error("end_date")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
