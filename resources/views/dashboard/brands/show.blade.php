    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">{{trans('admin.brands')}} </h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{trans('admin.home')}}</a>
                            </li>
                            <li class="breadcrumb-item active">{{trans('admin.brands')}}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> {{trans('admin.brands')}} </h4>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div class="col form-group">
                                        ...
                                        <p class="alert alert-info" style="background-color:rgb(26,60,119)">{{ $brand->getActive()  }}</p>
                                    </div>
                                    <div class="col form-group">
